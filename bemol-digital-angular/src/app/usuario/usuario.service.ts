...
export class UsuarioService {
  ...
  create(usuario): Observable<Usuario> {
    return this.httpClient
      .post<Usuario>(this.apiURL, JSON.stringify(usuario), this.httpOptions)
      .pipe(catchError(this.errorHandler));
  }
  ...
  update(id, cliente): Observable<Usuario> {
    return this.httpClient
      .put<Usuario>(this.apiURL + id, JSON.stringify(cliente), this.httpOptions)
      .pipe(catchError(this.errorHandler));
  }

  delete(id) {
    return this.httpClient
      .delete<Usuario>(this.apiURL + id, this.httpOptions)
      .pipe(catchError(this.errorHandler));
  }
